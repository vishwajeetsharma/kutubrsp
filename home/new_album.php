      ...
      Albums
        ...
        <li class="nav-item">
          <a href="/logout.php" class="nav-link"> Logout </a>
                ...
                <form action="new_album.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="album" class="form-control form-control-lg">
                    </div><br>
                    <div class="form-group d-grid gap-2">
                        <input type="submit" class="btn btn-primary btn-block btn-lg" name="add_album_btn" value="Add Album">
                    </div>
